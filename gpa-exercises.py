...
#Create global variables because you don't want these values to change
# Global variables have a global visibility
A_PLUS  = 4.0
A       = 4.0
A_MINUS = 3.7
B_PLUS  = 3.3
...
# parameter:  letter entered by user in readLetter function
...
assignGPA(readLetter())
def getGPA():
    given_gpa = float(input("Enter the gpa: "))
    return given_gpa
